...
{section name=index loop=$index}
	...
	{section name=contents loop=$index[index].index}
		<dt class="field">
			...
			<img src="{$subdir}images/{if $index[index].index[contents].access == 'private'}Private{/if}{$index[index].index[contents].title}.png" alt="{$index[index].index[contents].title}" title="{$index[index].index[contents].title}" /></title>
			<span class="var-title">{$index[index].index[contents].name}</span>
			{elseif ($index[index].index[contents].title == "Global")}
			<img src="{$subdir}images/{$index[index].index[contents].title}.png" alt="{$index[index].index[contents].title}" title="{$index[index].index[contents].title}" /></title>
			<span class="var-title">{$index[index].index[contents].name}</span>
			...
			<img src="{$subdir}images/{if $index[index].index[contents].abstract}Abstract{/if}{if $index[index].index[contents].access == 'private'}Private{/if}{$index[index].index[contents].title}.png" alt="{$index[index].index[contents].title}" title="{$index[index].index[contents].title}" /></title>
