...
<h2 class="file-name"><img src="{$subdir}images/Page_logo.png" alt="File" style="vertical-align: middle">{$source_location}</h2>
			...
			<table cellpadding="2" cellspacing="0" class="class-table">
				...
				<tr>
					<td style="padding-right: 2em; vertical-align: top; white-space: nowrap">
						<img src="{$subdir}images/{if $classes[classes].abstract}Abstract{/if}{if $classes[classes].access == 'private'}Private{/if}Class.png"
