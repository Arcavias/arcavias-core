...
/**
 * Default product stock unit item implementation.
 * @package MShop
 * @subpackage Product
 */
class MShop_Product_Item_Stock_Unit_Default
	extends MShop_Common_Item_Abstract
	implements MShop_Product_Item_Stock_Unit_Interface
{
	private $_values;
	...
	{
		parent::__construct('product.stock.unit.', $values);
	...
	public function toArray()
	{
		...
		$list['product.stock.unit.code'] = $this->getCode();
		$list['product.stock.unit.label'] = $this->getLabel();
		$list['product.stock.unit.status'] = $this->getStatus();
