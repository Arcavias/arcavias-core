 ...
 * @subpackage Html
 */
class Client_Html_Checkout_Confirm_Service_Default
	extends Client_Html_Common_Summary_Service_Default
{
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/checkout/confirm/service/default/template-body
		 ...
		 */
		$tplconf = 'client/html/checkout/confirm/service/default/template-body';
		$default = 'checkout/confirm/service-body-default.html';
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/checkout/confirm/service/default/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/checkout/confirm/service/default/template-body
		 */
		$tplconf = 'client/html/checkout/confirm/service/default/template-header';
		$default = 'checkout/confirm/service-header-default.html';
