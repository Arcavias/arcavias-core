...
class Client_Html_Email_Confirm_Main_Text_DefaultTest extends MW_Unittest_Testcase
{
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Email_Confirm_Main_Text_DefaultTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Confirm_Main_Text_Default( $this->_context, $paths );
	}
