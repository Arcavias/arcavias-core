...
class Client_Html_Email_Confirm_Main_Html_Service_DefaultTest extends MW_Unittest_Testcase
{
	protected $_object;
	protected $_context;
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Email_Confirm_Main_Html_Service_DefaultTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Confirm_Main_Html_Service_Default( $this->_context, $paths );
	}
