...
class Client_Html_Email_Confirm_Main_Html_Address_DefaultTest extends MW_Unittest_Testcase
{
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Email_Confirm_Main_Html_Address_DefaultTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Confirm_Main_Html_Address_Default( $this->_context, $paths );
	}
