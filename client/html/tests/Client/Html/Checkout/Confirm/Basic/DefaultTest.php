...
class Client_Html_Checkout_Confirm_Basic_DefaultTest extends MW_Unittest_Testcase
{
	protected $_object;
	protected $_context;
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Checkout_Confirm_Basic_DefaultTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Checkout_Confirm_Basic_Default( $this->_context, $paths );
