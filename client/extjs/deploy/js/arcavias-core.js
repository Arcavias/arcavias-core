...
Ext.onReady(function() {
    ...
    new Ext.Viewport({
        ...
        items: [{
            layout: 'fit',
            border: false,
            tbar: ['->', MShop.i18n.available ? {xtype: 'MShop.elements.siteLanguage.combo'} : {}, ' ', {xtype: 'MShop.elements.site.combo'}],
            items: [{
                xtype: 'tabpanel',
                border: false,
...
MShop.elements.exportlanguage.Window = Ext.extend( Ext.Window, {
	...
	onExportItem: function()
	{
		...
		Ext.MessageBox.alert(
			...
			MShop.I18n.dt( 'client/extjs', 'The file with the exported texts will be available within a few minutes. It can then be downloaded from the "Job" panel of the "Overview" tab.' ) );
	},
...
MShop.panel.coupon.code.ListUi = Ext.extend(MShop.panel.AbstractListUi, {
	...
	onBeforeLoad: function(store, options) {
		...
		if( !this.ParentItemUi.record.data['coupon.id'] ) {
	        Ext.Msg.alert(
	        	MShop.I18n.dt( 'client/extjs', 'Notice' ),
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.order.ItemUi', 'MShop.panel.order.base.address.ItemUi', MShop.panel.order.base.address.ItemUi, 10);/*!
 * Copyright (c) Metaways Infosystems GmbH, 2011
 * LGPLv3, http://www.arcavias.com/en/license
 */
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.order.ItemUi', 'MShop.panel.order.base.product.ListUi', MShop.panel.order.base.product.ListUi, 20);
/*!
 * Copyright (c) Metaways Infosystems GmbH, 2011
 * LGPLv3, http://www.arcavias.com/en/license
 */
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.order.ItemUi', 'MShop.panel.order.base.service.ListUi', MShop.panel.order.base.service.ListUi, 30);
/*!
 * Copyright (c) Metaways Infosystems GmbH, 2014
 * LGPLv3, http://www.arcavias.com/en/license
 */
...
MShop.panel.cache.ListUiSmall = Ext.extend(MShop.panel.AbstractListUi, {
	...
	onFlush: function() {
        ...
        Ext.Msg.show({
            ...
            msg: MShop.I18n.dt( 'client/extjs', 'You are going to flush the complete cache for the current site. Would you like to proceed?' ),
            buttons: Ext.Msg.YESNO,
            fn: function (btn) {
                if (btn == 'yes') {
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.type.tabUi', 'MShop.panel.plugin.type.listui', MShop.panel.plugin.type.ListUi, 30);
/*!
 * Copyright (c) Metaways Infosystems GmbH, 2014
 * LGPLv3, http://www.arcavias.com/license
 * @author Michael Spahn <m.spahn@metaways.de>
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.type.tabUi', 'MShop.panel.price.type.listui', MShop.panel.price.type.ListUi, 40);
/*!
 * Copyright (c) Metaways Infosystems GmbH, 2014
 * LGPLv3, http://www.arcavias.com/license
 * @author Michael Spahn <m.spahn@metaways.de>
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.type.tabUi', 'MShop.panel.product.type.listui', MShop.panel.product.type.ListUi, 50);
/*!
 * Copyright (c) Metaways Infosystems GmbH, 2014
 * LGPLv3, http://www.arcavias.com/license
 * @author Michael Spahn <m.spahn@metaways.de>
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.type.tabUi', 'MShop.panel.service.type.listui', MShop.panel.service.type.ListUi, 60);
/*!
 * Copyright (c) Metaways Infosystems GmbH, 2014
 * LGPLv3, http://www.arcavias.com/license
 * @author Michael Spahn <m.spahn@metaways.de>
